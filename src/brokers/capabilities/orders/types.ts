...
export interface ValidatedCreateOrderRouteBody extends ValidatedCreateOrderBody {}
...
export interface BrokerOrdersAdapter {
  ...
  createOrder(assetId: string, body: ValidatedCreateOrderRouteBody, context?: BrokerOrderContext): Promise<unknown>;
