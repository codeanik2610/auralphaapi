...
const RELEASE_GATE_SCRIPT = String(
  process.env.ORDERS_PROOF_RELEASE_GATE_SCRIPT || 'scripts/release-gates/release-gate-orders.ts'
).trim();
const SIGNOFF_SCRIPT = String(
  process.env.ORDERS_PROOF_SIGNOFF_SCRIPT || 'scripts/signoffs/signoff-orders.ts'
).trim();
