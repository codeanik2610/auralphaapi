...
import {
  buildFvgFakeoutContinuationTemplatePayload,
  FVG_FAKEOUT_CONTINUATION_TEMPLATE_NAME,
} from '../../src/api/strategies/templates/FvgFakeoutContinuationTemplate';
...
const installTemplate = async (): Promise<InstallResult> => {
  ...
  const payload = buildFvgFakeoutContinuationTemplatePayload();
