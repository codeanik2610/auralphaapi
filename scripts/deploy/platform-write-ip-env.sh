...
WHATSAPP_DELIVERY_ENABLED="$(preserve_env_value WHATSAPP_DELIVERY_ENABLED false)"
WHATSAPP_DELIVERY_PROVIDER="$(preserve_env_value WHATSAPP_DELIVERY_PROVIDER twilio)"
WHATSAPP_DELIVERY_POLL_INTERVAL_MS="$(preserve_env_value WHATSAPP_DELIVERY_POLL_INTERVAL_MS 5000)"
WHATSAPP_DELIVERY_BATCH_SIZE="$(preserve_env_value WHATSAPP_DELIVERY_BATCH_SIZE 10)"
WHATSAPP_DELIVERY_MAX_ATTEMPTS="$(preserve_env_value WHATSAPP_DELIVERY_MAX_ATTEMPTS 5)"
WHATSAPP_DELIVERY_STALE_MINUTES="$(preserve_env_value WHATSAPP_DELIVERY_STALE_MINUTES 10)"
WHATSAPP_TWILIO_ACCOUNT_SID="$(preserve_env_value WHATSAPP_TWILIO_ACCOUNT_SID)"
WHATSAPP_TWILIO_AUTH_TOKEN="$(preserve_env_value WHATSAPP_TWILIO_AUTH_TOKEN)"
WHATSAPP_TWILIO_FROM="$(preserve_env_value WHATSAPP_TWILIO_FROM)"
WHATSAPP_TWILIO_API_BASE_URL="$(preserve_env_value WHATSAPP_TWILIO_API_BASE_URL https://api.twilio.com/2010-04-01)"
...
SELFHOSTED_MYSQL_BINLOG_EXPIRE_LOGS_SECONDS=86400
...
BROKER_CANARY_MONITOR_ENABLED=true
BROKER_CANARY_MONITOR_LOOKBACK_HOURS=720
BROKER_CANARY_MONITOR_MAX_SUBMISSIONS=100
BROKER_CANARY_MONITOR_SNAPSHOT_STALE_AFTER_MS=900000
BROKER_CANARY_MONITOR_AUTO_FREEZE_ON_CRITICAL=false

SUGGESTED_TRADE_EXECUTION_SYNC_POLL_INTERVAL_MS=5000
SUGGESTED_TRADE_EXECUTION_SYNC_STALE_AFTER_MS=30000
...
EMAIL_WORKER_HEARTBEAT_KEY=email:worker:heartbeat
WHATSAPP_WORKER_HEARTBEAT_KEY=whatsapp:worker:heartbeat

EMAIL_DELIVERY_ENABLED=false
EMAIL_DELIVERY_POLL_INTERVAL_MS=5000
EMAIL_DELIVERY_BATCH_SIZE=10
EMAIL_DELIVERY_MAX_ATTEMPTS=5
EMAIL_DELIVERY_STALE_MINUTES=10
EMAIL_SMTP_HOST=
EMAIL_SMTP_PORT=587
...
WHATSAPP_DELIVERY_ENABLED=${WHATSAPP_DELIVERY_ENABLED}
WHATSAPP_DELIVERY_PROVIDER=${WHATSAPP_DELIVERY_PROVIDER}
WHATSAPP_DELIVERY_POLL_INTERVAL_MS=${WHATSAPP_DELIVERY_POLL_INTERVAL_MS}
WHATSAPP_DELIVERY_BATCH_SIZE=${WHATSAPP_DELIVERY_BATCH_SIZE}
WHATSAPP_DELIVERY_MAX_ATTEMPTS=${WHATSAPP_DELIVERY_MAX_ATTEMPTS}
WHATSAPP_DELIVERY_STALE_MINUTES=${WHATSAPP_DELIVERY_STALE_MINUTES}
WHATSAPP_TWILIO_ACCOUNT_SID=${WHATSAPP_TWILIO_ACCOUNT_SID}
WHATSAPP_TWILIO_AUTH_TOKEN=${WHATSAPP_TWILIO_AUTH_TOKEN}
WHATSAPP_TWILIO_FROM=${WHATSAPP_TWILIO_FROM}
WHATSAPP_TWILIO_API_BASE_URL=${WHATSAPP_TWILIO_API_BASE_URL}
...
TRADING_API_BROKER_CANARY_HEALTH_URL=http://auralpha-api:3000/api/v1/health/broker-canary
...
CANDLES_INTERVAL=1m
CANDLES_LOOKBACK_DAYS=30
CANDLES_SYMBOL_CONCURRENCY=10
CANDLES_MAX_RPS=18
CANDLES_INCREMENTAL_REQUEST_LIMIT=100
CANDLES_SKIP_GAP_FILL_ON_INCREMENTAL=false
...
BROKER_ACCOUNT_SECRETS_KEY=${BROKER_ACCOUNT_SECRETS_KEY}
SCHEDULER_SECRET=${DISCOVERY_SCHEDULER_SECRET}
