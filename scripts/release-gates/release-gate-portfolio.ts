...
async function run(): Promise<void> {
  ...
  const checks: GateCheckDefinition[] = [
    {
      key: 'backend-portfolio-suite',
      label: 'Backend portfolio suite',
      cwd: BACKEND_CWD,
      command: resolveTestCommand('test:portfolio'),
    },
    {
      ...
      command: [
        ...
        'scripts/test-portfolio.ts',
        'scripts/checks/check-portfolio-health.ts',
        'scripts/proofs/proof-portfolio-live.ts',
        'scripts/release-gates/release-gate-portfolio.ts',
        'scripts/signoffs/signoff-portfolio.ts',
      ],
    },
    {
