...
async function run(): Promise<void> {
  ...
  const checks: GateCheckDefinition[] = [
    {
      key: 'backend-risk-scheduler-suite',
      label: 'Backend risk scheduler suite',
      cwd: BACKEND_CWD,
      command: resolveTestCommand('test:risk-scheduler'),
    },
    {
      key: 'backend-risk-center-suite',
      label: 'Backend risk-center suite',
      cwd: BACKEND_CWD,
      command: resolveTestCommand('test:risk-center'),
    },
    {
    ...
    },
    {
      ...
      command: [
        ...
        'scripts/checks/check-risk-center-health.ts',
        'scripts/checks/check-risk-scheduler-health.ts',
        'scripts/release-gates/release-gate-risk-scheduler.ts',
        'scripts/signoffs/signoff-risk-scheduler.ts',
        'scripts/test-risk-scheduler.ts',
        'scripts/test-risk-center.ts',
      ],
    },
    {
