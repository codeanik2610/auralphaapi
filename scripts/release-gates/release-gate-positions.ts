...
async function run(): Promise<void> {
  ...
  const checks: GateCheckDefinition[] = [
    {
      key: 'backend-positions-suite',
      label: 'Backend positions suite',
      cwd: BACKEND_CWD,
      command: resolveTestCommand('test:positions'),
    },
    {
      ...
      command: [
        ...
        'src/env.ts',
        'scripts/test-positions.ts',
        'scripts/checks/check-positions-health.ts',
        'scripts/release-gates/release-gate-positions.ts',
        'scripts/signoffs/signoff-positions.ts',
      ],
    },
    {
