...
async function run(): Promise<void> {
  ...
  const checks: GateCheckDefinition[] = [
    {
      key: 'backend-asset-price-sync-suite',
      label: 'Backend asset-price-sync consolidated suite',
      cwd: BACKEND_CWD,
      command: resolveTestCommand('test:asset-price-sync'),
    },
    {
      key: 'backend-asset-price-sync-global-regression',
      label: 'Backend shared global-system-scheduler regression',
      cwd: BACKEND_CWD,
      command: resolveTestCommand('test:global-system-schedulers'),
    },
    {
    ...
    },
    {
      ...
      command: [
        ...
        'scripts/checks/check-asset-price-sync-health.ts',
        ...
        'scripts/proofs/proof-asset-price-sync-live.ts',
        'scripts/test-asset-price-sync.ts',
