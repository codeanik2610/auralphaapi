...
async function run(): Promise<void> {
  ...
  const checks: GateCheckDefinition[] = [
    {
      key: 'backend-positions-scheduler-suite',
      label: 'Backend positions scheduler suite',
      cwd: BACKEND_CWD,
      command: resolveTestCommand('test:positions-scheduler'),
    },
    {
