...
async function run(): Promise<void> {
  ...
  const checks: GateCheckDefinition[] = [
    {
      key: 'backend-global-system-schedulers-suite',
      label: 'Backend global system schedulers suite',
      cwd: BACKEND_CWD,
    ...
    },
    {
      ...
      command: [
        ...
        'scripts/test-global-system-schedulers.ts',
        'scripts/test-global-system-schedulers-suite.ts',
    ...
    },
    {
      ...
      cwd: WORKER_CWD,
      command: resolveTestCommand('test:reconciliation'),
    },
    {
