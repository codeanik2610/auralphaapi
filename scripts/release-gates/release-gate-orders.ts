...
async function run(): Promise<void> {
  ...
  const checks: GateCheckDefinition[] = [
    {
      key: 'backend-orders-suite',
      label: 'Backend orders suite',
      cwd: BACKEND_CWD,
      command: resolveTestCommand('test:orders'),
    },
    {
    ...
    },
    {
      ...
      command: [
        ...
        'scripts/test-orders.ts',
        'scripts/test-orders-contract.ts',
        'scripts/test-orders-live-proof.ts',
        'scripts/test-controllers.ts',
        'scripts/checks/check-orders-health.ts',
        'scripts/proofs/proof-orders-live.ts',
        'scripts/release-gates/release-gate-orders.ts',
        'scripts/signoffs/signoff-orders.ts',
      ],
    },
    {
