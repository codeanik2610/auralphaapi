...
async function run(): Promise<void> {
  ...
  const checks: GateCheckDefinition[] = [
    {
      key: 'backend-funds-scheduler-suite',
      label: 'Backend funds scheduler suite',
      cwd: BACKEND_CWD,
      command: resolveTestCommand('test:funds-scheduler'),
    },
    {
    ...
    },
    {
      ...
      command: [
        ...
        'scripts/test-funds-scheduler.ts',
        'scripts/checks/check-funds-scheduler-health.ts',
        'scripts/proofs/proof-funds-scheduler-live.ts',
        'scripts/proofs/proof-funds-scheduler-promotion.ts',
        'scripts/release-gates/release-gate-funds-scheduler.ts',
        'scripts/signoffs/signoff-funds-scheduler.ts',
