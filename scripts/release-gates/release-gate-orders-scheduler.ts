...
async function run(): Promise<void> {
  ...
  const checks: GateCheckDefinition[] = [
    {
      key: 'backend-orders-scheduler-suite',
      label: 'Backend orders scheduler suite',
      cwd: BACKEND_CWD,
      command: resolveTestCommand('test:orders-scheduler'),
    },
    {
    ...
    },
    {
      ...
      command: [
        ...
        'scripts/test-schedulers.ts',
        'scripts/checks/check-orders-scheduler-health.ts',
        'scripts/proofs/proof-orders-scheduler-live.ts',
        'scripts/release-gates/release-gate-orders-scheduler.ts',
        'scripts/signoffs/signoff-orders-scheduler.ts',
      ],
    },
    {
