...
const RELEASE_GATE_SCRIPT = String(
  process.env.PORTFOLIO_PROOF_RELEASE_GATE_SCRIPT || 'scripts/release-gate-portfolio.ts'
).trim();
const SIGNOFF_SCRIPT = String(
  process.env.PORTFOLIO_PROOF_SIGNOFF_SCRIPT || 'scripts/signoff-portfolio.ts'
).trim();
