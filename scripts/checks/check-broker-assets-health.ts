...
const isDirectRun = (() => {
  ...
  return (
    executedFile.endsWith(path.join('scripts', 'checks', 'check-broker-assets-health.ts')) ||
    executedFile.endsWith(path.join('scripts', 'checks', 'check-broker-assets-health.js'))
  );
})();
