...
container_json_output="/tmp/auralpha-delta-position-resolution-${timestamp}.json"
...
docker exec \
  ...
  -e SUGGESTED_TRADES_DELTA_POSITION_RESOLUTION_OUTPUT_FILE="${container_json_output}" \
  "${CONTAINER_NAME}" \
