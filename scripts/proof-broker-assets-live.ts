...
const SIGNOFF_SCRIPT = String(
  process.env.BROKER_ASSETS_PROOF_SIGNOFF_SCRIPT || 'scripts/signoff-broker-assets.ts'
).trim();
const HEALTH_SCRIPT = String(
  process.env.BROKER_ASSETS_PROOF_HEALTH_SCRIPT || 'scripts/check-broker-assets-health.ts'
).trim();
