...
curl_json "GET" "/alerts/overview?limit=5&offset=0"
curl_json "GET" "/markets/overview?limit=5&offset=0"
curl_json "GET" "/markets/BTCUSDT/chart?interval=1h&limit=10"
curl_json "GET" "/assets/catalog"
curl_json "GET" "/assets/futures?brokerKey=mudrex&limit=5&offset=0"
curl_json "GET" "/exchange-assets?limit=5&offset=0"
...
curl_json "GET" "/broker-accounts"
curl_json "GET" "/wallet/funds/active"
curl_json "GET" "/wallet/futures/funds/active"
curl_json "GET" "/funds-snapshots?limit=5&offset=0"
curl_json "GET" "/funds-snapshots/latest"
