...
import { buildSchedulerAccountScopeProofArtifacts } from './proof-scheduler-account-scope-live';
...
async function run(): Promise<void> {
  ...
  const checks: GateCheckDefinition[] = [
    {
      key: 'backend-scheduler-account-scope-phase3',
      label: 'Backend scheduler account-scope Phase 3 suite',
      cwd: BACKEND_CWD,
      command: [npmBin(), 'run', 'test:scheduler-account-scope-phase3'],
    },
    {
      key: 'backend-scheduler-account-scope-phase5',
      label: 'Backend scheduler account-scope Phase 5 suite',
      cwd: BACKEND_CWD,
      command: [npmBin(), 'run', 'test:scheduler-account-scope-phase5'],
    },
    {
      key: 'backend-scheduler-account-scope-phase6',
      label: 'Backend scheduler account-scope Phase 6 suite',
      cwd: BACKEND_CWD,
      command: [npmBin(), 'run', 'test:scheduler-account-scope-phase6'],
    },
    {
      key: 'backend-scheduler-account-scope-phase7',
      label: 'Backend scheduler account-scope Phase 7 suite',
      cwd: BACKEND_CWD,
      command: [npmBin(), 'run', 'test:scheduler-account-scope-phase7'],
    },
    {
